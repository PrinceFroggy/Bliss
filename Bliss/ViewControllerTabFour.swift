...
class ViewControllerTabFour: TabViewController, WKNavigationDelegate
{
    ...
    override func viewDidLoad()
    {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(activateKillSwitch), name: Notification.Name("tabFourKillSwitch"), object: nil)
