...
class ViewControllerTabTwo: TabViewController, WKNavigationDelegate
{
    ...
    override func viewDidLoad()
    {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(activateKillSwitch), name: Notification.Name("tabTwoKillSwitch"), object: nil)
